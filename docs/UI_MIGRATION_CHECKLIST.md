...
| Recent repository/session/Project/Gist actions | 1056 scenarios; 659 tests, all final #92 CI passed | #92 merged at `5218495`; final tree equals `9bcae00` | Shared/native overall gates only |
...
| `src/features/github/github-conversation-controls.tsx` | Retained-query notice, 11 px label; recovery regression passes | Conversation controls:192 write +80 read scenarios verified; PR #92 merged and verified. |
...
| `src/features/github/github-gist-editor-dialog.tsx` | Pending dismissal/input guard, refresh-safe drafts, named visibility group | 224 Gist action/read scenarios verify drafts, guards, duplicate files and recovery; PR #92 merged and verified. |
...
| `src/features/github/github-project-dialogs.tsx` | Pending guards, draft retention, read-only and empty-choice states implemented | 240 Project scenarios verify field/draft/settings/item recovery, permissions and empty choices; PR #92 merged and verified. |
...
| `src/features/github/github-reaction-bar.tsx` | Compact stale Retry, retained empty read-only feedback, keyboard description; recovery regressions pass | 96 reaction write +48 read scenarios verify pending, rollback, readonly owned removal, stale empty readonly and keyboard menu behavior; PR #92 merged and verified. |
| `src/features/github/github-reactions-provider.tsx` | Source reviewed; exposes refresh state; batching, optimistic updates and rollback preserved | 96 reaction write +48 read scenarios verify query/mutation reconciliation and retained failures; PR #92 merged and verified. |
...
| `src/features/github/github-repository-create-dialog.tsx` | Linked labels, pending/dismissal guards, inline/resettable failure and retained optional templates | 24 create +24 optional-template scenarios verify pending/drafts and optional read recovery; PR #92 merged and verified. |
...
| `src/features/github/github-repository-relationship-actions.tsx` | Shared controls/stale feedback, Fork guards, repository identity isolation, failed Star count recovery | 40 fork +72 relationship +16 switch/return captures verified; PR #92 merged and verified. |
