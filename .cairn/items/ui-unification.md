...
Audit and verify remaining Actions/check-suite, Wiki and advanced repository/action variants in the migration inventory.

## Verification

- Latest `pnpm check`: 517 tests/114 files plus complete-source lint/format/build; `pnpm exec tsc -b` passes. Logs `/private/tmp/harbor-discovery-final-check.log`, `/private/tmp/harbor-discovery-final-tsc.log`.
