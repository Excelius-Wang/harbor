...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        "harbor-popover grid min-w-[8rem] items-start gap-1.5 rounded-lg px-2.5 py-1.5 text-[11px]",
        className
      )}
    >
