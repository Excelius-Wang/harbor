...
export function GitHubPullRequestFileViewCheckbox({
  ...
  return (
    <label
      ...
      className="text-muted-foreground hover:text-foreground flex shrink-0 items-center gap-1.5 text-[11px] data-[disabled=true]:cursor-not-allowed data-[disabled=true]:opacity-60"
    >
      <Checkbox
      ...
      {presentation.changedSinceViewed ? (
        <span className="text-attention">{t("workspace.repositories.fileChangedSinceViewed")}</span>
      ) : null}
